                        ...
                        <p>
                            @if ($usuario->roles->isNotEmpty())
                                @foreach ($usuario->roles as $role)
                                    @if ($role->id == 1) <!-- Rol Admin/Pastor -->
                                        <span class="badge bg-gradient-primary">
                                            <i class="fas fa-crown"></i> {{ ucfirst($role->name) }}
                                        </span>
                                    @elseif ($role->id == 2) <!-- Rol Líder -->
                    ...
                    <div class="tab-pane active" id="general">
                        ...
                        <div class="card">
                            <div class="card-header bg-primary text-white">
                                <h3 class="card-title"><i class="fas fa-user-circle"></i> Perfil del Usuario</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <!-- Campo Nombre -->
                            ...
                            @can('editar configuracion informacion')
                                <div class="card-footer">
                                    <a href="{{ route('admin.usuarios.edit', $usuario->id) }}" class="btn btn-success">
